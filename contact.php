                                ...
                                <div class="contact">
                                    <form>
                                        <div class="contentContact">
                                            <div>
                                                <div class="name">
                                                    <span class="legend"><?php echo $contact_page[$language]['1'] ; ?>:</span><label class="text"><input type="text" name="nome" maxlength="18" required="" value="" /></label>
                                                </div>
                                                <div class="email">
                                                    <span class="legend"><?php echo $contact_page[$language]['2'] ; ?>:</span><label class="text"><input type="email" name="email" maxlength="50" required="" value="" /></label>
                                                </div>
                                            </div>
                                            <div>
                                                <span class="legend"><?php echo $contact_page[$language]['3'] ; ?>:</span><label class="textarea"><textarea name="msg" required=""></textarea></label>
                                            </div>
                                        </div>
                                        <div class="buttons">
                                            <button class="btYellowBig ic-send"><strong><?php echo $contact_page[$language]['4'] ; ?></strong></button>
                                        </div>
                                    </form>
                                </div>
                            </div>

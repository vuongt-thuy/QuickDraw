...
<!DOCTYPE html>
<html>
<!-- Mirrored from gartic.io/download by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Aug 2020 07:03:33 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <script>
        ...
        <title><?php echo $title[$language]['1'] ; ?></title>
        ...
        <link rel="preload" href="_next/static/jI9EZqYNN6u6IZXd9e4uV/pages/download.js" as="script" />
                ...
                <div id="content">
                    <div class="screenSystem" style="height: ;">
                        <div id="screens">
                            ...
                            <div>
                                <div class="title download-assets">
                                    <span class="gTitle"><h2>DOWNLOADS</h2></span>
                                </div>
                                <div class="content download">
                                    <div>
                                        <div class="figure"><figure class="logo"></figure></div>
                                        <div class="buttons">
                                            <p>GARTIC.IO LOGO</p>
                                            <span><?php echo $assets_page[$language]['0'] ; ?>:</span>
                                            <div><a href="static/download/logo.png" target="_blank">.png</a><a href="static/download/logo.svg" target="_blank">.svg</a></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="figure"><figure class="logo_line"></figure></div>
                                        <div class="buttons">
                                            <p>GARTIC.IO LOGO LINES</p>
                                            <span><?php echo $assets_page[$language]['0'] ; ?>:</span>
                                            <div><a href="static/download/logo_line.png" target="_blank">.png</a><a href="static/download/logo_line.svg" target="_blank">.svg</a></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="figure"><figure class="character"></figure></div>
                                        <div class="buttons">
                                            <p>GARTIC.IO CHARACTER</p>
                                            <span><?php echo $assets_page[$language]['0'] ; ?>:</span>
                                            <div class="cent"><a href="static/download/character.png" target="_blank">.png</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script async="" data-next-page="/download" src="_next/static/jI9EZqYNN6u6IZXd9e4uV/pages/download.js"></script>
...
<!-- Mirrored from gartic.io/download by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Aug 2020 07:03:35 GMT -->
</html>
